						...
						<div class="card contact-bx item-content">
							<div class="card-body user-profile pb-0">
								<div class="d-flex align-items-center">
									<div class="image-bx">
										<img src="<?php echo base_url('public/assets/images/pic1.jpg'); ?>" data-src="<?php echo base_url('public/assets/images/contacts/Untitled-3.jpg'); ?>" alt="" class="rounded-circle">
								...
								<div class="user-meta-info">
									<ul>
										<li><a href="javascript:void(0);"><i class="fas fa-phone-alt"></i></a>+12 345 6789 0</li>
										<li><a href="javascript:void(0);"><i class="far fa-comment-alt"></i></a>lincolndonin@mail.com</li>
									</ul>
								</div>
							</div>
						</div>
					...
					<div class="col-xl-3 col-xxl-4 col-lg-4 col-md-6 col-sm-6 items">
						<div class="card contact-bx item-content">
							<div class="card-body user-profile pb-0">
								<div class="d-flex align-items-center">
									<div class="image-bx">
										<img src="<?php echo base_url('public/assets/images/pic2.jpg'); ?>" data-src="<?php echo base_url('public/assets/images/contacts/Untitled-3.jpg'); ?>" alt="" class="rounded-circle">
										<span class="active"></span>
									</div>
									<div class="ms-3 text-start">
					...
					<div class="col-xl-3 col-xxl-4 col-lg-4 col-md-6 col-sm-6 items">
						<div class="card contact-bx item-content">
							<div class="card-body user-profile pb-0">
								<div class="d-flex align-items-center">
									<div class="image-bx">
										<img src="<?php echo base_url('public/assets/images/pic3.jpg'); ?>" data-src="<?php echo base_url('public/assets/images/contacts/Untitled-3.jpg'); ?>" alt="" class="rounded-circle">
										<span class="active"></span>
									</div>
									<div class="ms-3 text-start">
					...
					<div class="col-xl-3 col-xxl-4 col-lg-4 col-md-6 col-sm-6 items">
						<div class="card contact-bx item-content">
							<div class="card-body user-profile pb-0">
								<div class="d-flex align-items-center">
									<div class="image-bx">
										<img src="<?php echo base_url('public/assets/images/pic4.jpg'); ?>" data-src="<?php echo base_url('public/assets/images/contacts/Untitled-3.jpg'); ?>" alt="" class="rounded-circle">
										<span class="active"></span>
									</div>
									<div class="ms-3 text-start">
