							...
							<div class="col-xl-3 col-xxl-4">
								<div class="dlab-scroll chat-sidebar" id="chatSidebar">
									<div class="d-flex align-items-center justify-content-between px-2">
										<span class="m-3 d-block fs-16">GROUP</span>
										<i class="fas fa-plus text-primary"></i>
									</div>
									<div class="px-3">
										<div class="chat-bx-group px-2 d-flex align-items-center justify-content-between">
											<div class="user d-flex align-items-center">
												<a href="javascript:void(0);" class="bg-team1"><i class="fas fa-user-friends"></i></a>
												<span class="fs-18 font-w500 ms-3">Kleon Team</span>
											</div>
											<i class="fas fa-thumbtack scale5"></i>
											
										</div>
										<div class="chat-bx-group px-2">
											<div class="user d-flex align-items-center">
												<a href="javascript:void(0);" class="bg-team2"><i class="fas fa-user-friends"></i></a>
												<span class="fs-18 font-w500 ms-3">UI/UX Community</span>
											</div>
										</div>
										<div class="chat-bx-group px-2">
											<div class="user d-flex align-items-center">
												<a href="javascript:void(0);" class="bg-team3"><i class="fas fa-user-friends"></i></a>
												<span class="fs-18 font-w500 ms-3">We Are Designer</span>
											</div>
										</div>
										<div class="chat-bx-group px-2">
											<div class="user d-flex align-items-center">
												<a href="javascript:void(0);" class="bg-team4"><i class="fas fa-user-friends"></i></a>
												<span class="fs-18 font-w500 ms-3">We Are Designer</span>
											</div>
										</div>
										<div class="chat-bx-group px-2">
											<div class="user d-flex align-items-center">
												<a href="javascript:void(0);" class="bg-team5"><i class="fas fa-user-friends"></i></a>
												<span class="fs-18 font-w500 ms-3">Future Boss Grou..</span>
											</div>
										</div>
									</div>	
									<div class="recent-msg p-4 chat-bx">
									...
									<div class="">
										<div class="chat-bx  border-bottom">
											<div class="px-3 d-flex">
												<div class="chat-img">
													<img src="<?php echo base_url('public/assets/images/contacts/pic22.jpg'); ?>" alt="">
													<span class="active"></span>
												</div>
												<div class="w-100">
													<div class="d-flex mb-1 align-items-center">
														<span class="fs-16 text-black">Rayna Carder</span>
														<span class="fs-12 ms-auto badge badge-primary">New</span>
													</div>	
													<div>
										...
										<div class="chat-bx  border-bottom">
											<div class="px-3 d-flex">
												<div class="chat-img">
													<img src="<?php echo base_url('public/assets/images/contacts/pic11.jpg'); ?>" alt="">
													<span class="active"></span>
												</div>
												<div class="w-100">
													<div class="d-flex mb-1 align-items-center">
										...
										<div class="chat-bx  border-bottom">
											<div class="px-3 d-flex">
												<div class="chat-img">
													<img src="<?php echo base_url('public/assets/images/contacts/pic33.jpg'); ?>" alt="">
													<span class="active"></span>
												</div>
												<div class="w-100">
													<div class="d-flex mb-1 align-items-center">
								...
								<div class="d-flex justify-content-between align-items-center border-bottom px-4 pt-4 flex-wrap">
									<div class="d-flex align-items-center pb-3">
										<div class="fillow-design">
											<a href="javascript:void(0);"><i class="fas fa-user-friends"></i></a>
										</div>
										<div class="ms-3">
											<h4 class="fs-20 font-w700">Weekly Meet</h4>
									...
									<div class="chat-box-area dz-scroll" id="chartBox">
										<div class="media my-4  justify-content-start align-items-start">
											<div class="image-box me-sm-4 me-2">
												<img src="<?php echo base_url('public/assets/images/group/g1.jpg'); ?>" alt="" class="rounded-circle img-1">
										...
										<div class="media mb-4 justify-content-end align-items-end">
											...
											<div class="image-box ms-sm-4 ms-2 mb-4">
												<img src="<?php echo base_url('public/assets/images/contacts/3.jpg'); ?>" alt="" class="rounded-circle img-1">
												<span class="active"></span>
											</div>
										</div>
										<div class="media mb-4 justify-content-end align-items-end">
										...
										<div>
											...
											<button type="button" class="btn">	
												<svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
													...
													<path d="M0 9.35251H16V10.6062H0V9.35251Z" fill="#717579"/>
												</svg>
											</button>
										</div>
