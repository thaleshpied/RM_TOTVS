...
<div class="content-body">
	<div class="container-fluid">
		...
		<div class="row">
			...
			<div class="col-xl-6">
				<div class="card">
					<img class="card-img-top img-fluid" src="<?php echo base_url('public/assets/images/card/1.png'); ?>" alt="Card image cap">
					<div class="card-header">
						<h5 class="card-title">Card title</h5>
					</div>
					<div class="card-body">
			...
			<div class="col-xl-6">
				<div class="card">
					<img class="card-img-top img-fluid" src="<?php echo base_url('public/assets/images/card/2.png'); ?>" alt="Card image cap">
					<div class="card-header">
						<h5 class="card-title">Card title</h5>
					</div>
					<div class="card-body">
			...
			<div class="col-xl-6">
				<div class="card">
					...
					<img class="card-img-bottom img-fluid" src="<?php echo base_url('public/assets/images/card/3.png'); ?>" alt="Card image cap">
					<div class="card-footer">
						<p class="card-text d-inline">Card footer</p>
						<a href="javascript:void(0);" class="card-link float-end">Card link</a>
					</div>
