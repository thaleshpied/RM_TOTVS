...
<div class="content-body"> 
	<div class="container-fluid">
		<div class="row page-titles mt-3">
			<ol class="breadcrumb">
				<li class="breadcrumb-item active"><a href="javascript:history.back()">Gestão de Montagens</a></li>
								...
								<div class="card">
									<div class="card-header">
                                        ...
                                        <div class="btn-group mb-1">
                                            <!-- <button type="button" class="btn btn-primary light px-3"  id="exportar_pdfEX"><i class="fa fa-file-pdf-o" aria-hidden="true"> Exportar PDF</i></button>
                                            <button type="button" class="btn btn-primary light px-3"  id="exportar_excelEX"><i type="button" class="fa fa-file-excel-o"> Exportar Excel</i></button> -->
                                        </div>
											...
											<table id="emexecucao" class="display" style="min-width: 845px; width:100%;">
												<thead>
													<tr>
														...
														<th scope="col">DATA MONTAGEM</th>
														<th scope="col">DATA DESMONTAGEM</th>
														<th scope="col"></th>
													</tr>
												</thead>
												<tbody>	
                            ...
                            function datatableEX() {
                                ...
                                var table = $('#emexecucao').DataTable({
                                    ...
                                    columns: [
                                        ...
                                        { data: "ENCARREGADO" },
                                        { data: "DATA_MONTAGEM" },
                                        { data: "DATA_DESMONTAGEM" },
                                        {
                                            data: null,
                                            render: function(data, type, row) {
                                                return '<div class="d-flex">' +
                                                    '<a href="atendimentoPL/' + row.IDMOVPLANEJAMENTO + '"  class="btn btn-light  me-2 mb-2 btn-xxs">' +
                                                    '<i class="fa fa-laptop" aria-hidden="true" data-bs-toggle="modal" data-bs-target="#ed' + row.IDMOVPLANEJAMENTO + '" data-id="ed' + row.IDMOVPLANEJAMENTO + '"></i></a>';
                                            }
                                        }
                                    ],
                                    buttons: [
