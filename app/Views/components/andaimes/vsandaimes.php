                ...
                <div class="card">
					<div class="row" styler="margin-left:20px;">
						<div class="col-12">         
							...
							<a href="atendimentoVS/<?php echo $p['IDMOV']; ?>"><button style="margin-left: 10px;" type="button" class="btn btn-light  me-2 mb-2 btn-xxs" id="accord-2One">
					...
					<div class="card">
						<div class="card-body">
							<div class="accordion accordion-start-indicator" id="accordion-two">
								...
								<div id="collapse2One<?php echo $p['IDMOV']; ?>" class="collapse accordion__body" aria-labelledby="accord-2One" data-bs-parent="#accordion-two">
