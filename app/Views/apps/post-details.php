					...
					<div class="profile-head">
						...
						<div class="profile-info">
							<div class="profile-photo">
								<img src="<?php echo base_url('public/assets/images/profile/profile.png'); ?>" class="img-fluid rounded-circle" alt="">
							</div>
						...
						<div class="card">
							<div class="card-body">
								<div class="profile-blog">
									...
									<img src="<?php echo base_url('public/assets/images/profile/1.jpg'); ?>" alt="" class="img-fluid mt-4 mb-4 w-100">
									<h4><a href="<?php echo site_url('/post-details'); ?>" class="text-black">Darwin Creative Agency Theme</a></h4>
							...
							<div class="card-body">
								<div class="profile-interest">
									...
									<div class="row mt-4 sp4" id="lightgallery">
										<a href="<?php echo base_url('public/assets/images/profile/2.jpg'); ?>" data-exthumbimage="<?php echo base_url('public/assets/images/profile/2.jpg'); ?>" data-src="<?php echo base_url('public/assets/images/profile/2.jpg'); ?>" class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
											<img src="<?php echo base_url('public/assets/images/profile/2.jpg'); ?>" alt="" class="img-fluid">
										</a>
										<a href="<?php echo base_url('public/assets/images/profile/3.jpg'); ?>" data-exthumbimage="<?php echo base_url('public/assets/images/profile/3.jpg'); ?>" data-src="<?php echo base_url('public/assets/images/profile/3.jpg'); ?>" class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
											<img src="<?php echo base_url('public/assets/images/profile/3.jpg'); ?>" alt="" class="img-fluid">
										</a>
										<a href="<?php echo base_url('public/assets/images/profile/4.jpg'); ?>" data-exthumbimage="<?php echo base_url('public/assets/images/profile/4.jpg'); ?>" data-src="<?php echo base_url('public/assets/images/profile/4.jpg'); ?>" class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
											<img src="<?php echo base_url('public/assets/images/profile/4.jpg'); ?>" alt="" class="img-fluid">
										</a>
										<a href="<?php echo base_url('public/assets/images/profile/3.jpg'); ?>" data-exthumbimage="<?php echo base_url('public/assets/images/profile/3.jpg'); ?>" data-src="<?php echo base_url('public/assets/images/profile/3.jpg'); ?>" class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
											<img src="<?php echo base_url('public/assets/images/profile/3.jpg'); ?>" alt="" class="img-fluid">
										</a>
							...
							<div class="card-body">
								<div class="profile-news">
									...
									<div class="media pt-3 pb-3">
										<img src="<?php echo base_url('public/assets/images/profile/5.jpg'); ?>" alt="image" class="me-3 rounded" width="75">
										<div class="media-body">
											<h5 class="m-b-5"><a href="<?php echo site_url('/post-details'); ?>" class="text-black">Collection of textile samples</a></h5>
											<p class="mb-0">I shared this on my fb wall a few months back, and I thought.</p>
										</div>
									</div>
									<div class="media pt-3 pb-3">
										<img src="<?php echo base_url('public/assets/images/profile/6.jpg'); ?>" alt="image" class="me-3 rounded" width="75">
										<div class="media-body">
											<h5 class="m-b-5"><a href="<?php echo site_url('/post-details'); ?>" class="text-black">Collection of textile samples</a></h5>
											<p class="mb-0">I shared this on my fb wall a few months back, and I thought.</p>
										</div>
									...
									<div class="media pt-3 pb-3">
										<img src="<?php echo base_url('public/assets/images/profile/7.jpg'); ?>" alt="image" class="me-3 rounded" width="75">
										<div class="media-body">
											<h5 class="m-b-5"><a href="<?php echo site_url('/post-details'); ?>" class="text-black">Collection of textile samples</a></h5>
											<p class="mb-0">I shared this on my fb wall a few months back, and I thought.</p>
										</div>
				...
				<div class="card">
					<div class="card-body">
						<div class="post-details">
							...
							<img src="<?php echo base_url('public/assets/images/profile/8.jpg'); ?>" alt="" class="img-fluid mb-3 w-100 rounded">
