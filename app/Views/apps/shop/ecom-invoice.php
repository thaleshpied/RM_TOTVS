	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<div class="card mt-3">
					<div class="card-header"> Invoice <strong>01/01/2024</strong> <span class="float-end">
								...
								<div class="row align-items-center">
									<div class="col-sm-9"> 
										<div class="brand-logo mb-3">
											<img class="logo-abbr me-2" width="50" src="<?php echo base_url('public/assets/images/logo.png'); ?>" alt="">
											<img class="logo-compact" width="110" src="<?php echo base_url('public/assets/images/logo-text.png'); ?>" alt="">
										</div>
									...
									<div class="col-sm-3 mt-3"> <img src="<?php echo base_url('public/assets/images/qr.png'); ?>" alt="" class="img-fluid width110"> </div>
								</div>
							</div>
						</div>
