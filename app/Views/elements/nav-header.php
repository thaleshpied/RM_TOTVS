...
<div class="nav-header">
    <a href="<?php echo site_url('/index'); ?>" class="brand-logo">
        ...
        <img src="<?php echo site_url('/public/assets/images/logo.png'); ?>" alt="image" class="logo-abbr" width="100" height="55" viewBox="0 0 80 80">
