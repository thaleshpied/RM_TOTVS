    ...
    <?php if (!empty($resultado)): ?>
        <?php foreach($resultado as $t): ?>
            <div class="col-12 text-center mt-3">
                <i class="fa fa-qrcode" aria-hidden="true"> <h4 class="mb-0"><?php echo $t['IDMOV']; ?></h4></i> <br>   
            </div>
            <div class="col-12 text-center mt-3">	
              ...
              <div class="post-input">
								...
								<div class="product-detail-content">
									...
									<div class="new-arrival-content pr">
										...
										<h4>OS TOP ANDAIMES - <small> <?php echo $t['IDMOV']; ?></small></h4>
                   							

                    <p>[Altura]: <span class="item">20,50 </span> - [Largura]: 10,50</p>

										<span class="review-text">Atividade</span>
                    <p>Tarefa: <span class="item"><?php echo $t['SAMF_CLI_TEXTO_BREVE']; ?> </span> - Descrição: <?php echo $t['SAMF_CLI_DESC_OP']; ?></p>
                    ...
                    <p><span class="item"><?php echo $t['SAMF_OBSERVACAO']; ?></span> </p>
										...
										<span class="review-text">Tag de andaime:</span>&nbsp;&nbsp;
                    ...
                    <div class="col-xl-6 mt-4 col-sm-6">
										<div class="d-flex">
											...
											<div>
												<h4 class="fs-18 font-w500 text-black">Atualizado em <small>dd</small></h4>
											</div>
										</div>
									</div>
