    ...
    *
    ...
    SELECT 
        ...
        FROM TMOV
            ...
            LEFT JOIN
            TTRBMOV ON TMOV.IDMOV = TTRBMOV.IDMOV AND TMOV.CODCOLIGADA = TTRBMOV.CODCOLIGADA
    ...
    // PEGANDO INDICATIVO DE FRETE 
    public function getIndicativoDeFrete($IDMOV)
    {
    $query = $this->db->query("
        SELECT TOP 1 INDNATFRETE FROM 
		TITMMOVFISCAL WHERE IDMOV = ?
        ", [$IDMOV]);        
        return $query->getRow();
    }
    ...
    public function getItensRegistroFiscal($IDMOV)
    {
    $query = $this->db->query("SELECT 
    ...
    LEFT JOIN
    TMOV ON TMOV.IDMOV = TITMMOV.IDMOV AND TITMMOV.CODCOLIGADA = TMOV.CODCOLIGADA 
